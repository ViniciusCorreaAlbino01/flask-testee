...
class ClienteForm(FlaskForm):
    ...
    cep = DecimalField('cep',validators=[DataRequired('Preencha com o seu cep'),Length(min=8,max=8)])
    ...
    banco = DecimalField('banco',validators=[DataRequired('Preencha com o codigo do seu banco'), Length(min=3,max=3)])
    agencia = DecimalField('agencia',validators=[DataRequired('Preencha com o numero da sua agencia'),Length(min=4,max=4) ])
    ...
    matricula = DecimalField('matricula',validators=[DataRequired('Preencha com o numero do seu benefício'),Length(min=10,max=10) ])